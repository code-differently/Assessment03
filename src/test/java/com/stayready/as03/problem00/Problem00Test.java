...
public class Problem00Test {
    ...
    //Changed cause I kept getting an array that had blank spaces due to the expression points
    @Test
    ...
    //Changed the test cause it appears two times and is unique and is appears 6 times
    @Test
